...
export const StackOverflowIcon: React.SFC<TSvgProps> = props => {
  return (
    <svg
      id="Bold"
    ...
    >
      ...
      />
      <path fill="currentColor" d="m6.215 17.571h10.566v2.127h-10.566z" />
      <path
        fill="currentColor"
        d="m7.8 9.831 9.572 4.526.887-1.944-9.577-4.538z"
      />
      <path fill="currentColor" d="m17.373 14.358-.001-.001-.001.001z" />
      <path
        fill="currentColor"

...
export const experiences: Experience[] = [
  {
    ...
    achievements: [
      ...
      "I've shipped products and features spanning from design systems, dev tools, micro-frontend frameworks, messaging and data ingestion services and AI-powered features.",
    ],
    href: "https://vtex.com",
  },
  {
  ...
  },
  {
    ...
    achievements: [
      ...
      "I've developed the ecommerce of the largest dancing program from Brazil, FitDance, and the backend services and frontend platforms (B2B and B2C) for the largest credit consignment platform of Brazil's Northeast Region, Credcesta.",
    ],
    href: "https://cubos.io",
  },
];
